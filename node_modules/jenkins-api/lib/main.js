    ...
    return {
        ...
        last_build_info: function(jobname, callback) {
            ...
            */
            request({
                method: 'GET',
                url: build_url(LAST_BUILD, jobname)
            }, function(error, response, body) {
                if (error || response.statusCode !== 200) {
                    callback(error || true, response);
                    return;
        ...
        last_completed_build_info: function(jobname, callback) {
            ...
            */
            request({
                method: 'GET',
                url: build_url(LAST_COMPLETED_BUILD, jobname)
            }, function(error, response, body) {
                if (error || response.statusCode !== 200) {
                    callback(error || true, response);
                    return;
        ...
        build_info: function(jobname, number, callback) {
            ...
            */
            request({
                method: 'GET',
                url: build_url(BUILD_INFO, jobname, number)
            }, function(error, response, body) {
                if (error || response.statusCode !== 200) {
                    callback(error || true, response);
                    return;
        ...
        last_build_report: function(jobname, callback) {
            ...
            */
            request({
                method: 'GET',
                url: build_url(LAST_REPORT, jobname)
            }, function(error, response, body) {
                if (error || response.statusCode !== 200) {
                    callback(error || true, response);
                    return;
        ...
        last_success: function(jobname, callback) {
            ...
            */
            request({
                method: 'POST',
                url: build_url(LAST_SUCCESS, jobname)
            }, function(error, response, body) {
                if (error || response.statusCode !== 200) {
                    callback(error || true, response);
                    return;
        ...
        last_result: function(jobname, callback) {
            ...
            */
            this.job_info(jobname, function(error, data) {
                ...
                request({
                    method: 'GET',
                    url: build_url(last_result_url + API, jobname)
                }, function(error, response, body) {
                    if (error || response.statusCode !== 200) {
                        callback(error || true, response);
                        return;
        ...
        computers: function(callback) {
            ...
            request({
                method: 'GET',
                url: build_url(COMPUTERS + '?depth=1')
            }, function(error, response, body) {
                if (error || response.statusCode !== 200) {
                    callback(error || true, response);
                    return;
        ...
        job_output: function(jobname, buildname, callback) {
            ...
            */
            request({
                method: 'POST',
                url: build_url(JOB_OUTPUT, jobname + '/' + buildname)
            }, function(error, response, body) {
